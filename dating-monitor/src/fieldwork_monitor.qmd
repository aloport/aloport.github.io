...
**Last updated:** `r format(Sys.time(), "%A %B %d, %Y at %H:%M %Z")` | **Next auto-update:** every 30 minutes via GitHub Actions (until March 22, 2026)
:::
...
process_country <- function(cfg, country_key) {
  ...
  # --- Keep only completers (answered all 10 rounds) ---
